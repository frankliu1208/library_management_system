(function(window) {
    ...
    var pagination = function(options) {
        ...
        html += '<span class="page-total"> In total <span class="number">' + total + '</span> Pages </span>\
          <span class="page-go"> Go to <input class="w35 go" id="yeshu" type="text" value=""> Pages </span>\

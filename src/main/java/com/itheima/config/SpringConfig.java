...
@Configuration
// put MyBatisConfig.java and JdbcConfig.java to this configuration class.   @configuration means that this is a configuration class, we need to import also JdbcConfig.java.

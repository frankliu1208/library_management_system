...
<body class="hold-transition skin-red sidebar-mini">
            ...
            <c:forEach items="${pageResult.rows}" var="user">
                <tr>
                    ...
                    <td class="text-center">
                        <%-- when status is Normal for the user, we have the modify and delete buttons      --%>
                        <c:if test="${user.status == 0}">
    ...
    <!-- Editing window,  when clicking modify button, open this window, comes from L89 - 90  -->
